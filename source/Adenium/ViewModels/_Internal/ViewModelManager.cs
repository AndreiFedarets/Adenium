...
namespace Adenium.ViewModels
{
    internal class ViewModelManager : IViewModelManager
    {
        ...
        //public T FindFirstViewModelChild<T>(IItemsViewModel itemsViewModel, Func<T, bool> condition = null) where T : IViewModel
        //{
        //    foreach (IViewModel viewModel in itemsViewModel)
        //    {
        //        if (!(viewModel is T))
        //        {
        //            continue;
